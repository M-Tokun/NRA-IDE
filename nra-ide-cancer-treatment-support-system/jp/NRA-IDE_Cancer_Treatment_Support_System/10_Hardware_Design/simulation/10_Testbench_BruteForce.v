 ...
 * Rev:  2.0 (2026-07-29) 5段パイプラインへの追従、visc の Q8.8 値を訂正
 * 目的: 5段パイプライン遅延を考慮した Boost 最適値の自動探索
 * ═══════════════════════════════════════════════════════════════════════ */
...
module Testbench_BruteForce;
    ...
    initial begin
        ...
        visc  = 16'h000C; // 0.05 (切り捨て量子化。他ファイルと同一値)
        diam  = 16'h0C00; // 12.0
        pore  = 16'h0800; // 8.0
        flow  = 16'h0099; // 0.6
        ...
        repeat (1000) begin
            ...
            // 5段パイプラインの完了待ち (o_out_valid が立ち上がるまで待機)
            wait(o_out_valid == 1);
