...
<!-- README.md | examples/en/ | 2026-02-09 -->
...
This is a deterministic control engine based on **Tension Structure (Constraint → Force → Displacement)**, completely eliminating linear concepts such as continuity, distance, and ambiguous semantics.

In high-risk areas where conventional methods often become "black boxes" (such as Medical AI, Autonomous Driving, and Critical Infrastructure), NRA-IDE provides a judgment mechanism that is **fully explainable and free from error accumulation**.
...
| **R** | Ratio | Judgment is made based on the value of δ ÷ τ. |

| Value of R | Judgment | Action |
|------------|----------|--------|
| R < 1.0 | **SAFE** | AI presents physical evidence and continues processing. |
| R ≥ 1.0 | **STOP** | System halts → Human makes the final decision. |

> **Design Philosophy:** The AI is strictly for calculation. Ethical and final decisions are the responsibility of humans. (Boundary of Responsibility)
...
To integrate this logic into your own program, you simply define the "Violation (δ)" and "Tolerance (τ)" of the control target. Physical control begins immediately.
...
| Auto | Obstacle Margin | Braking Distance | Collision Danger → Emergency Stop. |
...
- **Inverse Derivation (Π⁻¹):** Implementations that derive internal states from distances or coordinates.
- **Weapons & Military Systems:** Use in weaponry, guidance systems, or attack support.
- **Surveillance & Oppression:** Use in discriminatory control systems.
- **Unverified Safety Critical Systems:** Incorporation into medical devices, vehicles, or aircraft without safety assurance.
- Any other application likely to cause physical, psychological, or societal harm.
...
If citing this project in an academic or technical context:
...
For technical integrity principles (L∧P∧C∧D) and core theory, please refer to:

- **Theoretical Basis:** Technical documents in the `/docs/` folder.
- **Implementation Specs:** Comments within the source code of each HTML file.
- **Unified Definition:** `NRA-IDE_The_Gate_Axioms__Unified_Definition_.MD`
