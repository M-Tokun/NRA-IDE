...
| # | File | Content |
|---|------|---------|
| 06 | `06_Escapement_Principle_EN.html` *(in preparation)* | **Why gears never accumulate error.** Animated comparison of floating-point drift vs. integer phase lock. Visualizes the structural reason NRA-IDE is free from cumulative error. |
