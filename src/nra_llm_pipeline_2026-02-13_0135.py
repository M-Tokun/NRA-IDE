...
# 既存エンジンをインポート
from nra_document_structure_20260213_0135 import (
...
class NRALLMPipeline:
    ...
    def run(
        ...
        from nra_document_structure_20260213_0135 import StructureValidator
...
if __name__ == "__main__":
    ...
    from nra_document_structure_20260213_0135 import DocumentEngine, DomainType
