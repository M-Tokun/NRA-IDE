...
# ==============================================================================
# ⚠️ Safety Boundary Declaration
# ------------------------------------------------------------------------------
# This tool (nra_crystallizer) is a "text summarization aid for humans",
# NOT the NRA-IDE safety gate itself.
#
# Semantic keyword matching via SINGULARITY_KEYWORDS is permitted for text
# crystallization purposes only. Reusing this logic in NRA-IDE safety gates
# (Coherence Gate, Causal Diode, etc.) is STRICTLY PROHIBITED.
#
# Reason: Keyword-meaning-dependent judgment violates NRA-IDE's
#         "Non-Semantic" principle.
#
# Note: momentum is an internal variable for threshold adjustment,
# NOT equivalent to NRA-IDE's tau (thickness). Tau is always positive.
# ==============================================================================
...
class DynamicFilterEngine:
    ...
    def process(self, particle: Particle):
        ...
        # --- Phase 3: Residue (Discard) ---
            ...
            # Note: momentum is a threshold-adjustment variable, NOT NRA-IDE's tau.
            # Tau is always positive. Negative momentum only tightens the filter.
