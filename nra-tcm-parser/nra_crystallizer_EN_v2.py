...
#
# Semantic keyword matching via intuition_keywords is permitted for text
...
class NRACoreEN:
    ...
    def process_line(self, line: str) -> Optional[CrystalPoint]:
        ...
        # Logarithmic scale to avoid linear distance calculation (axiomatic compliance)
        delta = math.log1p(len(clean_content)) / 6.0  # Normalized for English
